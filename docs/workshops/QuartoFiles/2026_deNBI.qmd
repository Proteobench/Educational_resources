...
In the tab "Upload New Results (Private)", it is written _"Remember: contaminant sequences are already present in the fasta file associated to this module. Do not add other contaminants to your search. This is important when using MaxQuant and FragPipe, among other tools."_. 

**Q6.** Why is it important not to add other contaminants to your search in this module?
...
**Q7.** What does allow us to estimate the proportion of incorrect identifications in these data? Tip: it is in the FASTA.

**Q8.** Would the results of this module be the same if the data used as workflow input were generated with a timsTOF?

### Other modules

**Q9.** Does a high number of quantified precursor ions in the "Quant LFQ" modules mean that the precursor ions are correctly identified?

**Q10.** Why are some modules archived? What does this mean?

**Q11.** What type of data is not present in any ProteoBench module and would be of interest to you?

**Q12.** What is the difference between "ALPHA" and "BETA" modules?
